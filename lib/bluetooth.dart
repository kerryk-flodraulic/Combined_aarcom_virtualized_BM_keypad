...
class CanBluetooth {
 ...
 void startScan({void Function(BluetoothDevice, AdvertisementData)? onDeviceFound}) {
  ...
  FlutterBluePlus.scanResults.listen((results) {
    for (final r in results) {
      ...
      if (!scanResults.containsKey(device.remoteId.str)) {
        scanResults[device.remoteId.str] = r;
        addedDevice.notifyListeners();
      }

      if (onDeviceFound != null) {
        onDeviceFound(device, r.advertisementData);
      }
    }
  });
}
